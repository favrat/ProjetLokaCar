...
public class VehiculeContract {
    ...
    public static final int NUM_COL_VERSION_VEHICULE = 2;
    public static final int NUM_COL_COULEUR_VEHICULE = 3;
    public static final int NUM_COL_CNIT_VEHICULE = 4;
    //Etat
    public static final int NUM_COL_PRIX_VEHICULE = 5;
